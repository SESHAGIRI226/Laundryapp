      ...
      <div className="signupbody_c">
        <div className="p1">
          <div className="c1">
            ...
            <br />
            <div className="abc">
              <p2>Dryclean Service</p2>
              <br />
            </div>
            <div className="account"></div>
            <p1>Already Have Account</p1>
            <br />
            <Link to="/">
              <button className="signupinsignin">Sign In</button>
            </Link>
          </div>
        </div>
        {/* <p className="hr"></p> */}
            ...
            <form className="sign_form" onSubmit={(elem) => register(elem)}>
              <div className="sf_p">
                <div className="sf_c1">
                  ...
                  <br />
                  <input className="f_input" type="name" name="name"></input>
                  <br />
                  <label className="label">Phone</label>
                  <br />
                  <input className="f_input" type="phone" name="phone"></input>
                  <br />
                ...
                <div className="sf_c2">
                  ...
                  <br />
                  <input className="f_input" type="email" name="email"></input>
                  <br />
                  <label className="label">State</label>
                  <br />
                  <input className="f_input" type="text" name="state"></input>
                  <br />
              ...
              <div className="sf_c3">
                ...
                <label for="tc">
                  {" "}
                  I agree to Terms & Conditions receving marketing and
